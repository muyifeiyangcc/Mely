    ...
    return ScrollView {
      LazyVGrid(columns: TWT9nbh6VlsY3B, spacing: 12) {
        ForEach(Self.packages) { pkglKk7JX81uDqGxc in
          let t3fVsBnE9lFQs0 =
            pkglKk7JX81uDqGxc.id < walletProductIds.count
            ? walletProductIds[pkglKk7JX81uDqGxc.id] : nil
          Dc5TFZ6oWwkwmwOV(
            ...
            onTap: {
              ...
              IAPManager.shared.purchaseDiamonds(
                productId: t3fVsBnE9lFQs0,
                diamonds: pkglKk7JX81uDqGxc.diamiRCh7OLPItldoo,
                appDataStore: MdJ8ySgYQ7SMif
              ) { huiCGn5qji7aHM in
                Task { @MainActor in
                  Px61mhLeZFLMQh = nil

...
struct RepboModfiRKcX6DtMw2MFei: ViewModifier {
  ...
  var onReportSubmit: (RepReaRuRbLVXQxhizQZ, String) -> Void
  var onCancel: (() -> Void)?
...
extension View {
  func blorepEJWPcVqZsNi6EP(
    ...
    onReportSubmit: @escaping (RepReaRuRbLVXQxhizQZ, String) -> Void,
    onCancel: (() -> Void)? = nil
  ) -> some View {
    modifier(
